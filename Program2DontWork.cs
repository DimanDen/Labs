...
namespace Objects1
{
    ...
    class DrawObjects
    {         
        public static void Iniciallization(ref object[] arrayofobjects) //Method for work with object
        {
    ...
    class Program
    {
        ...
        static void Main()
        {
            object[] arrayofobjects = { new Polygon(Points), new Triangle(Points1), new Text(Point1, "Give me life, give me love \nScarlet angel from above \nNot so low, not so high \nKeep it perfectly disguised") };
